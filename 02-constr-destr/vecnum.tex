...
\lstinputlisting[basicstyle=\tiny]{ejemplos/02-constr-destr/smart-vecnum/vecnum.hpp}
\end{block}
\end{frame}

\begin{frame}[t]{Usando \emph{punteros primitivos}}
\begin{block}{vecnum.hpp}
\lstinputlisting[basicstyle=\tiny]{ejemplos/02-constr-destr/primitive-vecnum/vecnum.hpp}
\end{block}
\end{frame}
...
\begin{itemize}
  \item \textmark{valgrind} está integrado en \textmark{CLion}.
    \begin{itemize}
      ...
      \includegraphics[width=2em]{images/02-constr-destr/valgrind.png}
    \end{itemize}
  \mode<presentation>{\vfill\pause}
  \item Resultado en panel de \textmark{Run valgrind memcheck}.
\end{itemize}
\includegraphics[width=\textwidth]{images/02-constr-destr/vecnum-main-valgrind.png}
\mode<presentation>{\vfill\pause}
\includegraphics[width=\textwidth]{images/02-constr-destr/vecnum-ctor-valgrind.png}
\end{frame}
