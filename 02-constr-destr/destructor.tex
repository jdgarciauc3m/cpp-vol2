...
\mode<presentation>{
  \lstinputlisting[basicstyle=\tiny]{ejemplos/02-constr-destr/primitive-vecnum-destr/vecnum.hpp}
}
\mode<article>{
  \lstinputlisting{ejemplos/02-constr-destr/primitive-vecnum-destr/vecnum.hpp}
}
\end{block}
\end{frame}
