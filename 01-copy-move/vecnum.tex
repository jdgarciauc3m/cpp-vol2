...
\lstinputlisting[basicstyle=\tiny]{ejemplos/01-copy-move/smart-vecnum/vecnum.hpp}
\end{block}
\end{frame}

\begin{frame}[t]{Usando \emph{punteros primitivos}}
\begin{block}{vecnum.hpp}
\lstinputlisting[basicstyle=\tiny]{ejemplos/01-copy-move/primitive-vecnum/vecnum.hpp}
\end{block}
\end{frame}
...
\begin{itemize}
  \item \textmark{valgrind} está integrado en \textmark{CLion}.
    \begin{itemize}
      ...
      \includegraphics[width=2em]{images/01-copy-move/valgrind.png}
    \end{itemize}
  \mode<presentation>{\vfill\pause}
  \item Resultado en panel de \textmark{Run valgrind memcheck}.
\end{itemize}
\includegraphics[width=\textwidth]{images/01-copy-move/vecnum-main-valgrind.png}
\mode<presentation>{\vfill\pause}
\includegraphics[width=\textwidth]{images/01-copy-move/vecnum-ctor-valgrind.png}
\end{frame}
